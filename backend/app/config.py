...
class Settings(BaseSettings):
    ...
    DEVICE_TOKEN_EXPIRE_MINUTES: int = 60      # Device JWT: 1 hour (Spec §5.2 / Phase 3)
    
    # Database Configuration (PostgreSQL + PostGIS as sole authoritative v1 datastore per Spec §3.1)
    DATABASE_URL: str = os.getenv("DATABASE_URL", "postgresql+psycopg2://postgres:postgres@localhost:5432/roadsentinel")
    ...
    S3_BUCKET_NAME: str = os.getenv("S3_BUCKET_NAME", "roadsentinel-media")
